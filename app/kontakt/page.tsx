			...
			<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
					...
					<motion.div
						...
						transition={{ duration: 0.5 }}
						className="bg-[#E8F5FF] p-8 rounded-2xl"
					>
						<h2 className="text-2xl font-semibold mb-6 text-[#27AAE1]">
							Napisz do nas
						</h2>
						<form onSubmit={handleSubmit} className="space-y-6">
							<div>
								<label
									htmlFor="name"
									className="block text-sm font-medium text-[#27AAE1]"
								>
									Imię i nazwisko
								</label>
								<input
									...
									required
									className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#27AAE1] focus:ring-[#27AAE1]"
								/>
							</div>
							<div>
								<label
							...
							<button
								type="submit"
								className="w-full bg-[#27AAE1] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#1B7EB3] transition-all duration-300"
							>
								Wyślij wiadomość
							</button>
						</form>
					...
					<motion.div
						...
						className="space-y-8"
					>
						<div className="bg-[#E8F5FF] p-8 rounded-2xl">
							<h2 className="text-2xl font-semibold mb-6 text-[#27AAE1]">
								Dane kontaktowe
							</h2>
							<div className="space-y-4">
								<div className="flex items-start space-x-4">
									<div className="flex-shrink-0 w-6 h-6 text-[#27AAE1] mt-1">
										<svg
											viewBox="0 0 24 24"
											fill="none"
									...
									<div>
										<p className="font-medium text-[#27AAE1]">
											Email:
										</p>
										<a
											href="mailto:kontakt@fast-fol.pl"
											className="text-[#27AAE1] hover:text-[#1B7EB3]"
										>
											kontakt@fast-fol.pl
										</a>
									</div>
